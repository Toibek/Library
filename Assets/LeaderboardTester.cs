...
public class LeaderboardTester : MonoBehaviour
{
    ...
    void sendTest()
    {
        int lb = Random.Range(0, LeaderboardManager.Instance.Leaderboards.Count);
        ...
        LeaderboardManager.Instance.WriteToLeaderboard(LeaderboardManager.Instance.Leaderboards[lb],entry);
    }
}
